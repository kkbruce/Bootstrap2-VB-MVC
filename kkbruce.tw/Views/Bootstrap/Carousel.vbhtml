...
<body>
    ...
    <div id="myCarousel" class="carousel slide">
        <div class="carousel-inner">
            <div class="item active">
                <img src="~/Images/bootstrap/examples/slide-01.jpg" alt="">
                <div class="container">
            ...
            <div class="item">
                <img src="~/Images/bootstrap/examples/slide-02.jpg" alt="">
                <div class="container">
                    <div class="carousel-caption">
            ...
            <div class="item">
                <img src="~/Images/bootstrap/examples/slide-03.jpg" alt="">
                <div class="container">
                    <div class="carousel-caption">
    ...
    <div class="container marketing">
        ...
        <div class="featurette">
            <img class="featurette-image pull-right" src="~/Images/bootstrap/examples/browser-icon-chrome.png">
        ...
        <div class="featurette">
            <img class="featurette-image pull-left" src="~/Images/bootstrap/examples/browser-icon-firefox.png">
        ...
        <div class="featurette">
            <img class="featurette-image pull-right" src="~/Images/bootstrap/examples/browser-icon-safari.png">
    ...
    <script src="~/Scripts/bootstrap/holder/holder.js"></script>
</body>
</html>
